//header jQuery kod| När musen enter header section kommer den thorthunder texter glida ner
$("#headertop").mouseenter(function(){
    $(".header-thor-thunder").slideDown(1000);
});
//header jQuery kod| När musen enter banner section kommer den thorthunder texter fejda ut.
$("#banner").mouseenter(function(){
    $(".header-thor-thunder").fadeOut(3000);
});
//När man trycka på den tre linje hamburger menyn kommer navigation toggle ner i 3 ms samt den tre linje hamburger meny kommer dölja medan texter "stängt" (med id ex) kommer visa.
$("#hamburger").click(function(){
    $(".navigation").slideToggle(300);
    $("#hamburger").hide();
    $("#ex").show();
});
//När man trycka på texter "stäng" (med id ex) kommer navigation toggle up i 2 millisekunder, och sen texter "stäng" (med id ex) kommer dölja medan den tre linje hamburger meny kommer visa.
$("#ex").click(function(){
